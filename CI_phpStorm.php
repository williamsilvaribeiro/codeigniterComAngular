...
/**
 * ------------- NAO SUBIR ESSE ARQUIVO PARA O SERVIDOR --------------------- */
 ...
 *
 * *********DECLARAÇÃO DOS MODELS PARA CARREGAR NO CONTROLLER ****************
 *
 * @property PersonModel $personModel
 * @property Relatorios_model $relatorios_model
 * @property Principal_model $principal_model
 *
 *
 */
class CI_Controller{}
